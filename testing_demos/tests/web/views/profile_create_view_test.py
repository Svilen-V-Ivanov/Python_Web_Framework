...
class ProfileCreateViewTests(BaseTestCase):
    def test_create_profile__when_user_is_logged_in__expect_co_create_profile(self):
        profile_data = {
            'name': 'Doncho',
            'age': 20,
            'egn': 1234567890,
    ...
    def test_create_profile__when_anonymous_user__expect_co_redirect_to_login(self):
        profile_data = {
            'name': 'Doncho',
            'age': 20,
            'egn': 1234567890,
