...
class ProfileViewTests(BaseTestCase):
    def test_profiles_list_view__when_no_profiles_expect_empty_list_and_count_context(self):
        # Act
    ...
    def test_profiles_list_view__when_profiles_expect_list_of_profiles_and_header_count(self):
        # Arrange
        profiles_count = 9
        profiles = [
    ...
    def test_profiles_list_view__when_logged_in_user__username_to_be_correct(self):
        # Arrange
        username = 'doncho'
        credentials = {
            'username':username,
    ...
    def test_profiles_list_view__when_query_is_provided__expect_query_to_be_in_context(self):
        # Act
        response = self.client.get(reverse('list profiles'), data={
            'query': 'the-query',
        })
