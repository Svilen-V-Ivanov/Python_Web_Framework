...
class ProfileCreateFormTests(TestCase):
    def test_profile_create_form__disabled_fields__when_all__expect_all_to_be_disabled(self):
    ...
    def test_profile_create_form__disabled_fields__when_name_is_disabled__expect_name_to_be_disabled(self):
        # monkey patching
