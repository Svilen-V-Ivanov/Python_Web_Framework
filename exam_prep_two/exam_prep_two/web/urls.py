...
from exam_prep_two.web.views import index, create_profile, dashboard, create_game, details_profile, delete_game, \
    edit_profile, delete_profile, details_game, edit_game
