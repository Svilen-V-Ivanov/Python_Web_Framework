...
from rest_demo.api_todos.serializers import TodoForCreateSerializer, TodoForListSerializer, CategorySerializer, \
...
class ListCreateTodoApiView(rest_generic_views.ListCreateAPIView):
    ...
    def __apply_filters_to_queryset(self, queryset):
        ...
        for filter_name in self.filter_names:
            filter_id = self.request.query_params.get('category', None)
            if filter_id:
